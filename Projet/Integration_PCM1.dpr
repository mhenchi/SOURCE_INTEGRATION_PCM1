{—————————————————— MD2011-04 - ACTIA Colomiers - Informatique de Production ——}
...
begin
  ...
  else MessageBoxA(0,Pchar('Application en cours d''utilisation    '),Pchar('Contrôle '),MB_OK + MB_ICONEXCLAMATION + 0);
